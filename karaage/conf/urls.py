...
urlpatterns = patterns(
    ...
    url(r'^aafbootstrap/', 'karaage.common.views.common.samlredirect', name='aafbootstrap'),
    url(r'^samlredirect/', 'karaage.common.views.common.samlredirect', name='samlredirect'),
